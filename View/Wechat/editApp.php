        ...
        <div>
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <input value="{$data['name']}" name="name" style="width:300px;" class="form-control" type="text">
        ...
        <div>
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><input value="{$data['wx_app_id']}" name="wx_app_id" style="width:300px;" class="form-control" type="text"></td>
                </tr>
                <tr>
                    <td width="100px"><label for="">secret</label></td>
                    <td><input value="{$data['wx_secret_key']}" name="wx_secret_key" style="width:300px;" class="form-control" type="text"></td>
                </tr>
            </table>
        </div>
        <div>
            <table style="width: 100%;">
                ...
                <tr>
                    <td width="100px"><label for="">app_id</label></td>
                    <td><input value="{$data['open_app_id']}" name="open_app_id" style="width:300px;" class="form-control" type="text"></td>
                </tr>
                <tr>
                    <td width="100px"><label for="">secret_key</label></td>
                    <td><input value="{$data['open_secret_key']}" name="open_secret_key" style="width:300px;" class="form-control" type="text">
                    </td>
                </tr>
                <tr>
                    <td width="100px"><label for="">alias</label></td>
                    <td><input value="{$data['open_alias']}" name="open_alias" style="width:300px;" class="form-control" type="text"></td>
                </tr>
                <tr>
